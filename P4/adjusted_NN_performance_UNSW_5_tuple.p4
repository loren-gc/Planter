...
control SwitchIngress(
    ...
    action Layer0_Process(bit <10> offset){ 
        ...
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+19);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+20);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+21);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+22);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+23);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+24);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+25);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+26);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+27);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+28);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+29);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+30);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+31);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+32);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+33);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+34);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+35);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+36);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+37);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+38);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+39);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+40);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+41);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+42);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+43);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+44);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+45);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+46);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+47);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+48);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+49);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+50);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+51);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+52);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+53);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+54);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
        weights.read( weight, (bit<10>)offset+55);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[44:0];
        BitCount_l0(meta.XNOROutput);
    }
