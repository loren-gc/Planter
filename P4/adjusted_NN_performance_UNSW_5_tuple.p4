...
control SwitchIngress(
    ...
    */
	...
	bit <1> w_val;
        weights_0.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_1.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_2.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_3.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_4.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_5.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_6.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_7.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_8.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_9.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_10.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_11.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_12.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_13.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_14.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_15.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_16.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_17.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_18.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_19.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_20.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_21.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_22.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_23.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_24.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_25.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_26.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_27.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_28.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_29.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_30.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_31.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_32.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_33.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_34.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_35.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_36.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_37.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_38.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_39.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_40.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_41.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_42.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_43.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_44.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_45.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_46.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_47.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_48.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_49.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_50.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_51.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_52.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_53.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_54.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
	weights_55.read( w_val, (bit<32>)offset);
	XNOR(w_val);
	mets.XNORoutput = (bit<64>)meta.XNOROutput[44:0];
	BitCount_l0(meta.XNOROutput);
    }
