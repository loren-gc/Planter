...
control SwitchIngress(
    ...
    RegisterAction<bit<64>, bit<32>, bit<64>>(weights) read_weight = {
    ...
    action Layer1_Process(bit <10> offset){ 
        ...
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+2);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+3);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+4);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+5);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+6);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+7);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+8);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+9);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+10);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+11);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+12);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+13);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+14);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+15);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+16);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+17);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+18);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+19);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+20);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+21);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+22);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+23);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+24);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+25);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+26);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+27);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+28);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+29);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+30);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+31);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+32);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+33);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+34);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+35);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+36);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+37);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+38);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+39);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+40);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+41);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+42);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+43);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+44);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+45);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+46);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+47);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+48);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+49);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+50);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+51);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+52);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+53);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+54);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
        weight = read_weight.execute((bit<32>)offset+55);
        XNOR(weight);
        meta.XNOROutput = (bit<64>)meta.XNOROutput[55:0];
        BitCount_l1(meta.XNOROutput);
    }
